...
> 이 문서는 **가상 시나리오** 예시다. 실제 프로젝트에 복사해 제목·범위·경로만 바꿔 쓰면 된다. Harness 공식 레퍼런스는 [본 레포 harness-engineering.md](https://github.com/choijinwon/k-design/blob/main/monetization/references/harness-engineering.md)와 [revfactory/harness](https://github.com/revfactory/harness/tree/main/skills/harness/references)를 본다.
...
**끝.** 실제 수익화·에이전트 정의 풀세트는 [DESIGN.md](https://github.com/choijinwon/k-design/blob/main/monetization/DESIGN.md), [agents/](https://github.com/choijinwon/k-design/tree/main/monetization/agents), [skills/](https://github.com/choijinwon/k-design/tree/main/monetization/skills)를 본다.
